$(function () {
    ...
    if (time > night) {
        ...
        $('body').css('background', '#111111')
        $('#headDesc p').css('color', '#fff')
        styleElem.innerHTML = ".skill-wrapper .skill-progress .circle .mask:before {background-color:#ffb400 !important} .go .inset .numbers:after {color:#fff !important;} #nav ul li:before {background: #ffb400 !important;};#About h1::before {color: #444 !important;}";
        $('#headDesc .title h2').css('color', '#ffb400');
        $('#nav ul').css('background', '#111111')
        $('#nav ul li').css('background', '#444444')
        $('#headDesc .btn button.learn-more .circle').css('background', '#ffb400');
        ...
        $('#headDesc .title h2').css('color', '#72b626');
        $('#nav ul li:before').css('background', '#72b626');
        styleElem.innerHTML = ".skill-wrapper .skill-progress .circle .mask:before {background-color:#72b626 !important} .go .inset .numbers:after {color:#000 !important;}  #nav ul li:before {background: #72b626 !important;}#About h1::before {color: #eff0f0 !important;}"
        $('#nav ul').css('background', '#ffffff')
        $('#particles-js').css('background', '#fff')
