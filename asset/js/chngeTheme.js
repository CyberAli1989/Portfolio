$(function () {
    ...
    $('#nav ul li:first-child').click(function () {
        ...
        if (darkMod) {
            ...
            styleElem.innerHTML = "#nav ul li:before {background: #72b626 !important;}#About h1::before {color: #eff0f0 !important;}"
            ...
            styleElem.innerHTML = "#nav ul li:before {background: #ffb400 !important;};#About h1::before {color: #444 !important;}";
